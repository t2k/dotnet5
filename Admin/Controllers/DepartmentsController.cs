...
namespace KYC.Web.Areas.Admin.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            var departments = db.Departments.Include(d => d.Region);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,RegionId")] Department department)
        {
            ...
            ViewBag.RegionId = new SelectList(db.Regions, "Id", "RegionName", department.RegionId);
            return View(department);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,RegionId")] Department department)
        {
            if (ModelState.IsValid)
            {
